                        ...
                        : Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                SenticText(
                                  height: 1.2,
                                  // text: (cx.read('totalFav')).toString() +
                                  text: cx.totalFavourites.value.toString() +
                                      ' Total Favourites',
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          child: ListView.builder(
                                                                              ...
                                                                              scrollDirection: Axis.horizontal,
                                                                              itemCount: mycontroller.myList[index].sportsList.length,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        text:
                                                                          ...
                                                                          children: <TextSpan>[
                                                                            ...
                                                                            TextSpan(
                                                                              text: League ? ' / Team' : ' / Hour',
                                                                              style: TextStyle(
                                                                                fontWeight: FontWeight.w500,
                                                                                overflow: TextOverflow.ellipsis,
                                                                                fontSize: cx.height > 800 ? 15 : 12,
                                                                              ),
                                                                            ),
                                                                          ],
                                                                        ),
