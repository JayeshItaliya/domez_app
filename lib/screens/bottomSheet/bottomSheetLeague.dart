...
class _BottomSheetLeagueState extends State<BottomSheetLeague> {
  ...
  void initState() {
    ...
    mycontroller.getTask2(mycontroller.sportid.value);
    mycontroller.getTask3(mycontroller.sportid.value);
  }
                          ...
                          () => mycontroller.isDataProcessing2.value||
                              ...
                              : mycontroller.myList2.length == 0 &&
                                  ...
                                  ? Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: Colors.white,
                                        borderRadius: BorderRadius.circular(cx.height / 22),
                                      ),
                                      child: Column(
                                        children: [
                                          Gap(cx.height / 44.47),
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Padding(
                                                                                  padding: EdgeInsets.fromLTRB(
                                                                                      cx.responsive(cx.width / 35,cx.width / 30,cx.width / 25),
                                                                                      cx.height / 83.375,
                                                                                      cx.responsive(cx.width / 35,cx.width / 30,cx.width / 25),
                                                                                      cx.height / 83.375),
                                                                                  child: Row(
