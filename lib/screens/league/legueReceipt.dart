                                ...
                                Center(
                                  child: SizedBox(
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        Container(
                                          decoration: errorLeagueImage.contains(
                                                  cx.read(Keys.domeId))
                                              ? BoxDecoration(
                                                  borderRadius:
                                                              ...
                                                              child: NunitoText(
                                                                textAlign:
                                                                    TextAlign
                                                                        .start,
                                                                text: int.parse(
                                                                            cx.read(LKeys.fieldName)) ==
                                                                        1
                                                                    ? "${cx.read(LKeys.fieldName)} Field"
                                                                    : "${cx.read(LKeys.fieldName)} Fields",
                                                                fontWeight:
                                                                    FontWeight
                                                                        .w500,
                                                                fontSize:
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        NunitoText(
                                                                            textAlign:
                                                                                TextAlign.end,
                                                                            text: "+ \$" + cx.read(LKeys.totalHST).toStringAsFixed(2),
...
//                    highlightAnimation: true,
                    ...
                    child: InkWell(
                      onTap: () async {
                        var result = await Get.to(
                            SignUp(curIndex: 2, noOfPopTime: 99),
  ...
  Future<void> makePayment() async {
    ...
    paymentIntent = await createPaymentIntent(
        cx.read(LKeys.total).toStringAsFixed(2), 'CAD');
    ...
    try {
      await Stripe.instance.presentPaymentSheet().then((value) {
        ...
        TaskProvider.paymentSuccessfulAPI(
                ...
                user_id: cx.read("islogin") ? cx.read("id").toString() : "",
                context: context,
                minSplitAmount: "",
                hst: cx.read(LKeys.totalHST).toStringAsFixed(2),
                service_fee: cx.read(LKeys.serviceFee).toStringAsFixed(2),
